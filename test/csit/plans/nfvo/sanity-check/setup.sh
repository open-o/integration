...
# Start extsys
docker run -d -i -t -e MSB_ADDR=$MSB_IP  -p 8100:8100 openoint/common-services-extsys i-esr

# Start resmgr
docker run -d -i -t -e MSB_ADDR=$MSB_IP  -p 8480:8480 openoint/nfvo-resmanagement
