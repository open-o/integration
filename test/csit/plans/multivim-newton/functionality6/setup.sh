...
ROBOT_VARIABLES+=" -v CREATE_NETWORK_JSON:${SCRIPTS}/../plans/multivim-newton/jsoninput/multivim_create_network.json"
ROBOT_VARIABLES+=" -v CREATE_SUBNET_JSON:${SCRIPTS}/../plans/multivim-newton/jsoninput/multivim_create_subnet.json"
ROBOT_VARIABLES+=" -v CREATE_PORT_JSON:${SCRIPTS}/../plans/multivim-newton/jsoninput/multivim_create_port.json"
