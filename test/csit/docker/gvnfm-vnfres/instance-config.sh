...
sed -i "s|DB_IP.*|DB_IP = '$MYSQL_IP'|" GVNFM_VNFRES_CONFIG_PATH/config.py
sed -i "s|DB_PORT.*|DB_PORT = $MYSQL_PORT|" GVNFM_VNFRES_CONFIG_PATH/config.py

cat GVNFM_VNFRES_CONFIG_PATH/config.py

sed -i "s|127\.0\.0\.1|$SERVICE_IP|" GVNFM_VNFRES_PATH/run.sh
sed -i "s|127\.0\.0\.1|$SERVICE_IP|" GVNFM_VNFRES_PATH/stop.sh
