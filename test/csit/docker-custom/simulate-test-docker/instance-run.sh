...
if [ $SIMULATOR_JSON == "Stubs/testcase/multivimdriver-vmware-vio/main.json" ]; then
 java -jar moco-runner-0.11.0-standalone.jar http -p 8774  -g Stubs/testcase/multivimdriver-vmware-vio/main_compute.json &
 java -jar moco-runner-0.11.0-standalone.jar http -p 9696  -g Stubs/testcase/multivimdriver-vmware-vio/main_network.json &
 java -jar moco-runner-0.11.0-standalone.jar http -p 8776  -g Stubs/testcase/multivimdriver-vmware-vio/main_volume.json &
 java -jar moco-runner-0.11.0-standalone.jar http -p 9292  -g Stubs/testcase/multivimdriver-vmware-vio/main_image.json &
 java -jar moco-runner-0.11.0-standalone.jar http -p 35357 -g Stubs/testcase/multivimdriver-vmware-vio/main_identity.json &
 java -jar moco-runner-0.11.0-standalone.jar http -p 5000  -g Stubs/testcase/multivimdriver-vmware-vio/main_identity.json &
