...
OVERLAY_TEMPLATE_FILE="template-openstack-driver.json"
OVERLAY_SIMU_FILE="openstack_sim_file.json"
OVERLAY_DRIVER_SIMU_FILENAME="sdnhub-driver-huawei-openstack.json"

SERVICE_TYPE="http"
DRIVER_LISTEN_PORT="8539";
DRIVER_SHUTDOWN_PORT="18539";
...
curl -d @$OVERLAY_SIMU_FILE -H "Content-Type: application/json;charset=UTF-8" http://$MSB_ADDR$DRIVERMANAGER_URL

#Start the simulated driver for OPENSTACK
