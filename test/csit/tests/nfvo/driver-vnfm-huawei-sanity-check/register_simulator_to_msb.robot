...
${register_json}    ${SCRIPTS}/../plans/nfvo/driver-vnfm-huawei-sanity-check/jsoninput/register_to_msb.json
...
registerVimdriverToMsb
    [Documentation]    register vimdriver simulator to msb
    ${json_value}=     json_from_file      ${register_json}
    Remove From Dictionary  ${json_value}   serviceName
