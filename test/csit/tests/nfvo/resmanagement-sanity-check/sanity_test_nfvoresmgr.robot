...
#json files
${resmgr_createvm_json}    ${SCRIPTS}/../plans/nfvo/resmanagement-sanity-check/jsoninput/resmgr_createvm.json
${resmgr_createvl_json}    ${SCRIPTS}/../plans/nfvo/resmanagement-sanity-check/jsoninput/resmgr_createvl.json
${resmgr_createvnfinfo_json}    ${SCRIPTS}/../plans/nfvo/resmanagement-sanity-check/jsoninput/resmgr_createvnfinfo.json
${resmgr_createvnf_json}    ${SCRIPTS}/../plans/nfvo/resmanagement-sanity-check/jsoninput/resmgr_createvnf.json
${resmgr_createvnfstatus_json}   ${SCRIPTS}/../plans/nfvo/resmanagement-sanity-check/jsoninput/resmgr_createvnfstatus.json
